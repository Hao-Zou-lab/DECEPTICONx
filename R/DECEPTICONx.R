...
#'
#' @examples
run_DECEPTICONx <- function (bulk.samples,sc.dat,subtype,cell_types=c("nk","b","cd4","cd8","fibroblast","macrophage"), RUNpath, light = TRUE, custom.template = FALSE ,custom.signature = TRUE,
